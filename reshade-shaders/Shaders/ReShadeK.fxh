...
namespace ReShade
{
	...
	//pixels of the anims with FXLightEnable = true will be placed here
    texture LightMaskTex : MASK;
    texture TopTex : TOPMASK;
    	//pixels of the anims with UseNormalLight = true will be placed here
    texture LightTex : LIGHT;
	//pixels of zbufferclass
    texture ZBufferTex : ZBUFFER;
	//pixels of laser result;
    //texture LaserTex : LASER;
	//pixels of shrouded and fogged alpha values;
    texture ShroudTex : SHROUD;
	//pixels of masked text ui and mouse
	//pixels of masked tmp values
    ...
    sampler Light { Texture = LightTex; };
    sampler ZBuffer { Texture = ZBufferTex; };
    //sampler Laser { Texture = LaserTex; };
    sampler Shroud { Texture = ShroudTex; };
